...
const Hero = () => {
    return (
        ...
        >
            ...
            <div className="relative z-10 flex w-full flex-col justify-center px-6 py-12 sm:px-[6.5%] lg:w-[70%]">
                ...
                <div className="grid mt-5 lg:grid-cols-4 grid-cols-2 items-center">
            ...
            <div className="absolute right-[4%] top-[12%] z-20 hidden border-l border-black/60 pl-5 text-[#2F3233] md:block">
